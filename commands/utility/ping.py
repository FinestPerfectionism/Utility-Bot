...
class PingCommands(commands.Cog, name="ping"):
    ...
    async def _check_and_ping(self, ctx: commands.Context, required_role_id: int, ping_role_id: int):
    ...
    async def ping_staff(self, ctx: commands.Context):
    ...
    async def ping_senior_moderators(self, ctx: commands.Context):
    ...
    async def ping_senior_administrators(self, ctx: commands.Context):
    ...
    async def ping_directors(self, ctx: commands.Context):
        if not ctx.guild or not isinstance(ctx.author, discord.Member):
            return
    ...
    async def ping_committee(self, ctx: commands.Context):
        if not ctx.guild or not isinstance(ctx.author, discord.Member):
            return
